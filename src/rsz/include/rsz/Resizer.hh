...
// R-tree types for spatial indexing of soft blockages
namespace bg = boost::geometry;
namespace bgi = boost::geometry::index;
using RtreePoint = bg::model::point<int, 2, bg::cs::cartesian>;
using RtreeBox = bg::model::box<RtreePoint>;
using RtreeValue = std::pair<RtreeBox, size_t>;
using SoftBlockageRtree = bgi::rtree<RtreeValue, bgi::quadratic<16>>;
...
class Resizer : public dbStaState, public dbNetworkObserver
{
 ...
 protected:
  ...
  // Spatial index for fast soft blockage overlap queries
  std::vector<odb::Rect> soft_blockages_;
  SoftBlockageRtree soft_blockage_rtree_;
